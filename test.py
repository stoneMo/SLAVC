...
def validate(testdataloader, audio_visual_model, object_saliency_model, model_dir, args):
    ...
    for step, (image, spec, bboxes, name) in enumerate(testdataloader):
        ...
        print(f'{step+1}/{len(testdataloader)}: AV+OGL-Prec@50={evaluator_av_obj.precision_at_50():.3f} AVL-Prec@50={evaluator_av.precision_at_50():.3f} OGL-Prec@50={evaluator_obj.precision_at_50():.3f}')
